  ...
  return (
    <div className="text-center py-16 px-6 bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-center gap-10 max-w-6xl mx-auto">
        ...
        <div className="flex-1">
          <img
			src="/coffee-illustration.svg"   // <-- works if you place image in public/
      ...
      <div className="mt-20 max-w-5xl mx-auto">
        <h2 className="text-2xl font-bold mb-8 text-kahawa-dark">
          Why KahawaPay?
        </h2>
      ...
      <div className="mt-20 py-10 bg-kahawa-dark text-white text-center rounded-lg shadow-inner">
        ...
        <p className="text-gray-200 max-w-2xl mx-auto">
          KahawaPay connects the diaspora with their buddies back home — 
          one coffee tip at a time.
        </p>
      </div>
    </div>
  )
